...
```yaml
- uses: Fin3-Technologies-Inc/gh-action-auto-commit@main
```
...
We also provide major version tags to make it easier to always use the latest release of a major version. For example you can use `Fin3-Technologies-Inc/gh-action-auto-commit@main` to always use the latest release of the current major version.
